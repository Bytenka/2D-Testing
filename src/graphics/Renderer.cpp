...
void Renderer::init()
{
	...
	*/
        ...
        LOG_ERROR("Could not initialize Renderer: {}", e.what());
...
void Renderer::dispose()
{
    try {
        ...
        LOG_ERROR("Could not dispose of Renderer: {}", e.what());
        throw Exception("Failed to dispose of Renderer");
    }
}
...
void Renderer::drawNewFrame()
{
    try {
        ...
        LOG_ERROR("Could not draw new frame: {}", e.what());
        throw Exception("Failed to draw new frame");
    }
}
